        ...
        <>
            <div>
                ...
                <div className="container">
                    ...
                    <div className={`items ${  "items_darkmode_active" }`} onClick={() => navigate('/itemList')
                    }><p>Items</p>
                        <img src={pokeball1} className='pokeball1' />
                        <img src={pokeball2} className='pokeball2' />
                        <img src={pokeball3} className='pokeball3' />
                    </div>
                    <div className="moves" onClick={()=>navigate('/moves')}><p>Moves</p>
                        <img src={moves} className='moveimg' />
                    </div>
